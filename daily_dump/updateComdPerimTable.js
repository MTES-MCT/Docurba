import sudocuhApprouve from './API_SUDOCUH_DU_approuve.json' assert {type: 'json'}
import sudocuhEncours from './API_SUDOCUH_DU_encours.json' assert {type: 'json'}

import { createClient } from '@supabase/supabase-js'
const supabase = createClient('https://ixxbyuandbmplfnqtxyw.supabase.co', 'API_KEY')
