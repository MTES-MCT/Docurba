...
DOCURBA_PROTOCOL = "https"
DOCURBA_FQDN = env.str("DOCURBA_FQDN", default="docurba.beta.gouv.fr")
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    {"NAME": "docurba.utils.password_validation.CnilCompositionPasswordValidator"},
]
