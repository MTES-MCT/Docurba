...
# Collectivite
user_collectivite_side = User.objects.get(email="celinems+test-collectivite@hey.com")
...
# PPA
user_ppa_side = User.objects.get(email="celinems+test-ppa@hey.com")
Profile.objects.get_or_create(
    user=user_ppa_side,
...
user_ddt_side = User.objects.get(email="celinems+test-ddt@hey.com")
Profile.objects.get_or_create(
    user=user_ddt_side,
    firstname="Oscar",
    lastname="Niemeyer",
