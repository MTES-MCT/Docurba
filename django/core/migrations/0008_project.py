    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_perimetre', django.contrib.postgres.fields.ArrayField(base_field=models.JSONField(blank=True, null=True), blank=True, null=True, size=None)),
                ('initial_perimetre', django.contrib.postgres.fields.ArrayField(base_field=models.JSONField(blank=True, null=True), blank=True, null=True, size=None)),
                ...
                ('from_sudocuh', models.IntegerField(blank=True, null=True, unique=True)),
                ('from_sudocuh_procedure_id', models.IntegerField(blank=True, null=True, unique=True)),
