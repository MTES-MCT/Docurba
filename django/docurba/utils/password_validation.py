...
class CnilCompositionPasswordValidator:
    ...
    - Minimum length: at least 16 characters (handled via `MinimumLengthValidator`)
    ...
    def validate(self, password: str, user: User = None) -> ValidationError | None:  # noqa: ARG002
        ...
        if (has_lower + has_upper + has_digit + has_special_char) < 3:  # noqa: PLR2004
