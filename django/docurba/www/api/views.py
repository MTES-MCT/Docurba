...
class PerimetresView(PublicAPIView, generics.GenericAPIView):
    def get(self, request: Request, *args, **kwargs) -> HttpResponse:  # noqa: ANN002, ANN003, ARG002
        try:
...
class CommunesView(PublicAPIView, generics.GenericAPIView):
    def get(self, request: Request, *args, **kwargs) -> HttpResponse:  # noqa: ANN002, ANN003, ARG002
        try:
            avant = _avant(request)
        except ValueError:
...
class ScotsView(PublicAPIView, generics.GenericAPIView):
    def get(self, request: Request, *args, **kwargs) -> HttpResponse:  # noqa: ANN002, ANN003, ARG002
        try:
            avant = _avant(request)
        except ValueError:
