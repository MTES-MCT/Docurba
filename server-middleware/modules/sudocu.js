...
async function getProceduresEvents ({ arrProceduresId, supabase }) {
  try {
...
async function getProceduresCollectivite ({ collectiviteId, supabase }) {
  ...
  const allProceduresEvents = await getProceduresEvents(proceduresCollecIds)
